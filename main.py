...
from common import log, const, common_timer
...
if __name__ == '__main__':
    ...
    parser.add_argument("--config",
                        help="config.json path(e.g: ./config.json  or  /usr/local/bot-on-anything/config.json)",
